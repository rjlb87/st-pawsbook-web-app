...
function Signin() {
    ...
    return (
        <div className="bg-gradient-to-r from-red-100 to-red-300 min-h-screen flex items-center justify-center p-8">
            <div className="w-full max-w-4xl p-8 flex items-center mt-10 ">
                <div className="flex-1">
                    <h1 className="text-4xl font-extrabold mb-10 pl-20 text-gray-600 uppercase">
                        Welcome to PAWSBOOK!
                    </h1>
                    <p className="text-2xl font-semibold pl-20 text-gray-800">
                        We are glad you're back..
                    </p>
                </div>
                <div className="pt-10 drop-shadow-lg">
                    <div className="flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0">
                        <div className="w-full bg-yellow-200 rounded-lg shadow dark:border md:mt-0 sm:max-w-md xl:p-0 dark:bg-gray-800 dark:border-gray-700">
